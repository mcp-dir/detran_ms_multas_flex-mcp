...
DETRAN MS Guia Flex: Multas segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_ms_multas_flex@mcp.ai](mailto:detran_ms_multas_flex@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
